...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        # use groupby to create relevant data for plotting
        exp_rec= recession_data.groupby('Vehicle_Type')['Total_Cost'].sum().reset_index()
        R_chart3 = dcc.Graph(figure=px.pie(exp_rec, values='Total_Cost', names='Vehicle_Type',
                                           title="Total Expenditure Share by Vehicle Type during Recessions"))

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        R_chart4 = dcc.Graph(figure=px.line(recession_data,x='unemployment_rate',y='Automobile_Sales',
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(data, x='Year', y='Automobile_Sales',
                                            title="Yearly Automobile Sales"))
            
# Plot 2 Total Monthly Automobile sales using line chart.
        Y_chart2 = dcc.Graph(figure=px.line(data, x='Month', y='Automobile_Sales',
        ...
        exp_data=yearly_data.groupby('Vehicle_Type')['Total_Cost'].sum().reset_index()
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values='Total_Cost', names='Vehicle_Type',
